...
const Footer = () => {
    ...
    return (
        <footer
            className="relative w-full text-white overflow-hidden selection:bg-blue-500/15 sm:min-h-[calc(100vh-500px)] flex flex-col justify-between"
            style={{
                background: "radial-gradient(circle at 20% 30%, #1a2332 0%, #0a0c10 100%)",
            }}
        >
            <div className="absolute -left-100 -top-32 w-1/2 h-[60vh] opacity-10 bg-image bg-left bg-contain pointer-events-none"></div>
            ...
            <div className="relative z-10 flex-1 flex items-center py-10">
                <div className="max-w-7xl mx-auto w-full px-4">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-12">
                        <div className="max-w-55.75" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div className="flex flex-col" data-aos="fade-up" data-aos-delay="360">
                            <h3 className="text-[#6994D4] text-xl font-semibold mb-4">
                                Follow Us
                            </h3>
            ...
            <div
                className="relative z-10 border-t border-white/10 py-5 text-sm text-[#94A3B8] text-center"
                data-aos="fade-up"
                data-aos-delay="420"
            >
