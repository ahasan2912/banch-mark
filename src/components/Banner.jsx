const Banner = () => {
    return (
        <div
            ...
            <div className="absolute -right-100 inset-0 opacity-10 bg-image z-50 -rotate-20 bg-center lg:bg-right bg-cover lg:bg-contain"></div>

            <main className="relative z-10 max-w-7xl mx-auto px-4 pb-20 pt-32">
