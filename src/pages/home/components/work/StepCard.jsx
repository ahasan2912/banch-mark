...
const StepCard = ({ step }) => {
    ...
    return (
        <div className={`relative flex flex-col p-4 rounded-lg bg-[#0a0f1e] border border-slate-800 shadow-xl transition-transform hover:scale-105 h-fit ${isOffset ? 'sm:mt-40' : ''}`}>
            <div className="mb-7">
