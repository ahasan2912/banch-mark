...
const Register = () => {
    ...
    const [handleRegister, { isLoading, error, isSuccess }] = useHandleRegisterMutation();
        ...
        <div className="w-full max-w-lg mx-auto px-3 sm:px-8 py-12">
            <div className='border border-gray-300 px-4 rounded-xl py-4'>
                ...
                <p className="text-gray-500 mb-8">
                    Already have an account? <Link to="/login" className="text-[#ed8793] font-semibold underline">Sign in</Link>
                </p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2 text-sm text-gray-600">
                            <input type="checkbox" {...register("rememberMe")} className="rounded border-gray-300 text-emerald-900 focus:ring-emerald-900" />
                            Remember me
                        </label>
