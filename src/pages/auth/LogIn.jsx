                ...
                <div className="min-h-screen w-full text-[#CBD5E1] relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 pb-20 pt-24 sm:pt-32">
                        <div className="flex items-center justify-center p-4 h-full">
                            <div className="w-full max-w-160 mx-auto bg-[#162031] rounded-xl p-8 md:p-12 shadow-2xl border border-white/5 relative z-10">
                                <div className="text-center mb-10">
                                    <h1 className="text-4xl font-semibold text-blue-200 mb-4">
                                        Welcome Back
                                    </h1>
