...
const Card = ({ image, title, description }) => (
  <div className="group relative rounded-lg bg-[#1A2C4D] p-6 hover:border-blue-400/50 transition-all duration-300 cursor-pointer overflow-hidden shadow-xl flex justify-center items-center">
