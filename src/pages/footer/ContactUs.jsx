            ...
            <div
                ...
                <div className="max-w-7xl mx-auto px-4 pb-20 pt-24 sm:pt-32">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full mt-10">
                        <div className="bg-[#0f172a]/50 border border-slate-800 p-8 rounded-xl backdrop-blur-sm">
                        ...
                        <div className="bg-[#0f172a]/50 border border-slate-800 p-8 rounded-xl backdrop-blur-sm space-y-6">
                            <h2 className="text-2xl font-semibold mb-6">Contact Information</h2>
                            <div className="flex items-center gap-4 bg-[#1e293b]/30 p-4 rounded-xl border border-slate-800">
                            ...
                            <div className="flex items-center gap-4 bg-[#1e293b]/30 p-4 rounded-xl border border-slate-800">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">We're here to help anytime day or night</p>
                                </div>
                            </div>
                        </div>
