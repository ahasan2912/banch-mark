...
import { useEditTargetMutation } from "../../../features/target/targetApi";
import { toast } from "react-toastify";

const EditTargetModal = ({ setIsModalOpen, targetInfo }) => {
    const modalRef = useRef();
    const [editTarget, { isLoading }] = useEditTargetMutation();
    const { id: targetId, name, projectId, sectionId } = targetInfo || {};
    ...
    const onSubmit = async (data) => {
        ...
        if (res?.data?.success) {
            ...
            toast.error(res?.data?.message || "Target update failed!");
        };
    };
        ...
        >
            <div
                ...
                <div className="flex justify-between items-center p-4 border-b border-gray-700">
                    <h2 className="text-xl font-semibold">Target Edit Form</h2>
                    <button
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                    <p className="text-base font-medium text-slate-300">
                        Target: <span className="font-semibold text-white">{targetInfo?.name}</span>
                    </p>
                    <div>
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        <button
                            ...
                            {isLoading ? "Edit Target..." : "Edit Target"}
                        </button>
                    </div>
                </form>
            </div>
