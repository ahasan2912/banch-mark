...
const AddCompanyModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-[#1e293b] w-full max-w-lg rounded-xl overflow-hidden shadow-2xl border border-slate-700">
        {/* Modal Header */}
        ...
        <form onSubmit={handleSubmit(onCompanySubmit)} className="p-5 space-y-4">
          ...
          <div className="bg-red-900/40 border border-red-900 text-red-200 p-3 rounded flex items-center gap-3">
